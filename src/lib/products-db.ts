...
export const SERIES_SELECT =
  "id, name:series_name, category, notes, production_time, code_rule, design_concept, faq_scripts, social_media_copy, website_article, customization_rules, website, image_url";
...
export const SERIES_SELECT_NO_WEBSITE =
  "id, name:series_name, category, notes, production_time, code_rule, design_concept, faq_scripts, social_media_copy, website_article, customization_rules, image_url";

/** product_variants 查詢欄位（含 series_id 關聯） */
export const VARIANT_SELECT =
  "id, series_id, product_code, wood_type, dimension_w, dimension_d, dimension_h, seat_height_cm, base_price, desktop_area, spec1, image_url";
