  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 刪除按鈕獨立於 form，避免部分瀏覽器將表單內 button 與 submit 行為綁在一起 */}
        <form id="company-calendar-event-edit" onSubmit={handleSubmit} className="mt-5 space-y-4">
          <div>
        ...
        {deleteConfirmOpen && (
          <div
            className="mt-4 rounded-lg border border-red-500/35 bg-red-950/25 px-3 py-3 text-sm text-[#ede5d8]"
            role="alert"
          >
        ...
        <div className="mt-4 flex flex-col gap-3 pt-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="order-1 flex w-full flex-col-reverse gap-2 sm:order-2 sm:w-auto sm:flex-row sm:justify-end">
            ...
            <button
              type="submit"
              form="company-calendar-event-edit"
              disabled={submitting || deleting}
              className={cn(
