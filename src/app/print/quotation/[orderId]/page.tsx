                ...
                items.map((item) => {
                  ...
                  return (
                    <tr key={item.id} className="border-b border-gray-200 align-top text-sm">
                      ...
                      <td className="px-2 py-2 text-right text-gray-900 tabular-nums">{item.quantity}</td>
            ...
            <dl className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                <dt className="text-gray-600">
                  訂金{depositPercent > 0 ? `（${depositPercent}%）` : ''}
                </dt>
                <dd className="text-gray-900 tabular-nums">{order.deposit_amount.toLocaleString()}</dd>
              </div>
            </dl>
          </div>
        </section>
